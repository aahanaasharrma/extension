...
function isWebsiteBlocked(hostname, callback) {
  chrome.storage.sync.get("blockedWebsites", (data) => {
    ...
    const isBlocked = blockedWebsites.some((blockedSite) => {
      ...
      console.log(regex.test(hostname), hostname)
